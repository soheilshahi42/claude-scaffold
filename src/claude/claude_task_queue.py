...
class ClaudeTaskQueue:
    ...
    def add_task(self, task_id: str, name: str, prompt: str, 
                 expect_json: bool = True, timeout: Optional[int] = None,
    ...
    def process_tasks(self, claude_processor, progress_callback: Optional[Callable] = None) -> Dict[str, Any]:
        ...
        with progress_indicator.batch_claude_operations(
            total_tasks, 
            f"Processing {total_tasks} Claude Tasks"
        ) as batch_progress:
