    ...
    def format_module_tasks(self, module_name: str, tasks: List[Dict]) -> str:
        ...
        for i, task in enumerate(tasks, 1):
            ...
            if "details" in task:
                ...
                formatted.append(
                    f"**Goal**: {details.get('goal', 'To be defined during research phase')}"
                )
                ...
                formatted.append("**Goal**: To be defined during research phase")

            formatted.append(f"\n**Research file**: docs/{self.slugify(task['title'])}.md")
            formatted.append("**Sub-tasks**: see TODO.md")
            formatted.append("")
        ...
        for module in project_data["modules"]:
            ...
            if tasks:
                for task in tasks:
                    ...
                    formatted.append(
                        f"- {priority_emoji} {task['title']} ← details in /{module['name']}/CLAUDE.md"
                    )
            else:
