    ...
    def __init__(self):
        self.project_types = {
            ...
            'library': {
                ...
                'test_framework': 'pytest',
                'build_commands': ['pip install -e .[dev]', 'pytest', 'black .', 'mypy .']
            },
            'api': {
                'name': 'API Service',
                'description': 'REST or GraphQL API service',
                'suggested_modules': ['routes', 'models', 'services', 'middleware', 'auth'],
                'suggested_rules': [
                ...
                'test_framework': 'pytest',
                'build_commands': ['pip install -r requirements.txt', 'pytest', 'uvicorn main:app --reload']
            },
            'ml': {
                'name': 'Machine Learning Project',
                'description': 'ML/Data Science project',
                'suggested_modules': ['data', 'models', 'training', 'evaluation', 'utils'],
                'suggested_rules': [
                ...
                'test_framework': 'pytest',
                'build_commands': ['pip install -r requirements.txt', 'pytest', 'python train.py']
            },
            'custom': {
                'name': 'Custom Project',
