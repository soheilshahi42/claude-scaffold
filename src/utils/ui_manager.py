...
class UIManager:
    ...
    @contextmanager
    def step_progress(self, title: str, total_steps: Optional[int] = None, show_timing: bool = True):
        ...
        class StepTracker:
            ...
            def complete(self, message: Optional[str] = None):
                ...
                if message:
                    ...
                    self.progress.update(self.task_id, description=f"{Icons.SUCCESS} {title} completed")
                if total_steps:
            ...
            for item in items:
                ...
                for key, value in item.items():
                    ...
                    if key == "status":
                        ...
                        color = {"high": "red", "medium": "yellow", "low": "green"}.get(str(value), "white")
    ...
    def prompt_with_progress(self, prompt: str, validator: Optional[Callable[[str], bool]] = None) -> str:
            ...
            while True:
                ...
                if validator:
                    if validator(user_input):
                        ...
                        self.console.print(f"{Icons.ERROR} Invalid input. Please try again.", style="red")
                else:
                    return user_input
