...
class TaskManager:
    ...
    def add_task(self, project_path: Path, module_name: str, task_title: str, priority: str = 'medium') -> bool:
        ...
        if module_claude.exists():
            ...
            new_task_section += f"**Goal**: To be defined during research phase\n"
            new_task_section += f"**Research file**: docs/{self.formatters.slugify(task_title)}.md\n"
            new_task_section += f"**Sub-tasks**: see TODO.md\n"
